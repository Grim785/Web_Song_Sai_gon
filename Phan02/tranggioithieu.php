...
<body>
    ...
    <div class="container-fluid mt-3">
      <div class="row row-cols-5 g-1">
        <img class="col" style="" src="../Phan02/public/imgs/3 (5).png" alt="">
        <img class="col" style="" src="../Phan02/public/imgs/3 (1).png" alt="">
        <img class="col" style="" src="../Phan02/public/imgs/3 (2).png" alt="">
        <img class="col" style="" src="../Phan02/public/imgs/3 (3).png" alt="">
        <img class="col" style="" src="../Phan02/public/imgs/3 (4).png" alt="">
      </div>
    </div>
